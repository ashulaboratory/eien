...
| / | 必要 | タイムライン (フィルタチップで全体/マイ/各グループに切替) |
| /chat | 必要 | チャット (プレースホルダー) |
| /posts/new | 必要 | マイルストーン作成 (複数グループ公開、0個も可) |
| /groups | 必要 | グループ一覧 |
| /groups/new | 必要 | グループ作成 |
| /groups/:id | 必要 | グループ詳細 (メンバー・シェアされたマイルストーン・招待発行) |
| /account | 必要 | アカウント (プレースホルダー) |
